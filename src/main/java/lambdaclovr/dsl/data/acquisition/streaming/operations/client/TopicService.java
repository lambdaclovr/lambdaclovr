...
import lambdaclovr.dsl.data.acquisition.streaming.operations.client.common.ClusterConnection;
import lambdaclovr.dsl.data.acquisition.streaming.operations.client.common.ClusterTools;
...
public class TopicService implements AutoCloseable {
     ...
     * @throws lambdaclovr.dsl.data.acquisition.streaming.operations.client.exception.ConnectionException if Zookeeper connection fails
     */
     ...
     * @throws lambdaclovr.dsl.data.acquisition.operations.client.exception.ConnectionException if Zookeeper connection fails
     */
     ...
     *                                                                                      or null.
     * @throws lambdaclovr.dsl.data.acquisition.streaming.operations.client.exception.TopicOperationException when configuration could not be overridden
     * @throws lambdaclovr.dsl.data.acquisition.operations.client.exception.ConnectionException     if Zookeeper connection fails
     */
     ...
     * @throws lambdaclovr.dsl.data.acquisition.streaming.operations.client.exception.TopicOperationException when topicName does not exist or
     ...
     * @throws lambdaclovr.dsl.data.acquisition.streaming.operations.client.exception.ConnectionException when Zookeeper connection failed
     */
