...
public class IndexService {
    public static void main(String[] args) {
        ...
        get("/querytest/:video", (request, response) -> {
            ...
            List<ResultRecord> features = new ArrayList<>();
            
            return new Gson().toJson(new StandardResponse(StatusResponse.SUCCESS, new Gson().toJsonTree(features)));
        });
        ...
        get("/query/:threshold/:video", (request, response) -> {
            ...
            result.add(new ResultRecord(filename + ",,," + threshold, 0.98));
        ...
        get("/query", (request, response) -> {
            ...
            return new Gson().toJson(new StandardResponse(StatusResponse.SUCCESS, TimeUnit.NANOSECONDS.toMillis(totalTime), new Gson().toJsonTree(results)));
        });
    }
}
